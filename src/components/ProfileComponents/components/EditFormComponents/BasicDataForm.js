                ...
                render={({ field: { onChange, onBlur, value, ...field } }) => (
                  ...
                  >
                    ...
                    <StyledField
                      ...
                      {...field}
                      borderColor={
                        errors?.firstName && value !== '' ? 'red.500' : 'grey'
                      }
                      InputLeftElement={
                        <Icon
                ...
                render={({ field: { onChange, onBlur, value, ...field } }) => (
                  ...
                  >
                    ...
                    <StyledField
                      ...
                      {...field}
                      borderColor={
                        errors?.lastName && value !== '' ? 'red.500' : 'grey'
                      }
                      InputLeftElement={
                        <Icon
                          as={<MaterialIcons name='person' />}
                ...
                render={({ field: { onChange, onBlur, value, ...field } }) => (
                  ...
                  >
                    ...
                    <StyledField
                      ...
                      {...field}
                      borderColor={
                        errors?.phone && value !== '' ? 'red.500' : 'grey'
                      }
                      InputLeftElement={
                        <Icon
                ...
                render={({
                  ...
                  >
                    ...
                    <StyledArea
                      ...
                      value={value}
                      borderColor={
                        errors?.address && value !== '' ? 'red.500' : 'grey'
                      }
                      {...field}
                      InputLeftElement={
                        <Icon
